...
def get_products():
    return jsonify({'status':'ok','products':[{'id':1,'name':'LUNA','type':'Сумка','price':12990},{'id':2,'name':'AURORA','type':'Кроссовки','price':7450},{'id':3,'name':'SKY','type':'Очки','price':4100}]})
...
def run_flask():
    logger.info(f"🚀 Flask: http://0.0.0.0:{PORT}")
